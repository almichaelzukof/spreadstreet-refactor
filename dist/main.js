!function(modules) {
    ...
    var obj, _inDOM = __webpack_require__(4), _inDOM2 = (obj = _inDOM) && obj.__esModule ? obj : {
        "default": obj
    };
    ...
    _inDOM2["default"] && [ "", "webkit", "moz", "o", "ms" ].some(function(vendor) {
    ...
    var react = __webpack_require__(0), react_default = __webpack_require__.n(react), react_dom = __webpack_require__(2), react_dom_default = __webpack_require__.n(react_dom), prop_types = (__webpack_require__(7), 
    __webpack_require__(1)), prop_types_default = __webpack_require__.n(prop_types);
    ...
    var form_input_FormInput = function(_React$Component) {
        function FormInput(props) {
            var _this, self, call;
            return function(instance, Constructor) {
                if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
            }(this, FormInput), self = this, (_this = !(call = _getPrototypeOf(FormInput).call(this, props)) || "object" !== _typeof(call) && "function" != typeof call ? _assertThisInitialized(self) : call).state = {
                text: ""
            }, _this.handleChange = _this.handleChange.bind(_assertThisInitialized(_this)), 
            _this.handleSubmit = _this.handleSubmit.bind(_assertThisInitialized(_this)), _this;
        }
        ...
        }(FormInput, react_default.a.Component), Constructor = FormInput, (protoProps = [ {
            key: "handleChange",
            value: function(e) {
                this.setState({
                    text: e.target.value
    ...
    var sheet_button_SheetButton = function(props) {
        var sheetIndex = props.name.sheetIndex, sheetName = props.name.text, isActiveSheet = props.name.isActive;
        return react_default.a.createElement("div", {
            className: "sheetLine"
        }, react_default.a.createElement("button", {
            onClick: function(e) {
                return props.deleteButtonHandler(e, sheetIndex);
            }
        }, "X"), react_default.a.createElement("span", {
            onClick: function(e) {
                return props.clickSheetNameHandler(e, sheetName);
            },
            className: "sheetNameText " + (isActiveSheet ? "active-sheet" : "")
        }, sheetName));
    };
    sheet_button_SheetButton.propTypes = {
    ...
    var components_App = function() {
        var _useState2 = _slicedToArray(Object(react["useState"])("Testing"), 2), header = _useState2[0], setHeader = _useState2[1];
        return Object(react["useEffect"])(function() {
            setHeader("It worked");
        }, [ header ]), react_default.a.createElement("div", null, react_default.a.createElement("h1", null, header), react_default.a.createElement("h1", null, "Fake header"));
    };
    react_dom_default.a.render(react_default.a.createElement(components_App, null), document.getElementById("index"));
} ]);
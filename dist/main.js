!function(modules) {
    ...
    "use strict";
    var bind = __webpack_require__(10), isBuffer = __webpack_require__(45), toString = Object.prototype.toString;
    ...
    "use strict";
    (function(process) {
        var utils = __webpack_require__(0), normalizeHeaderName = __webpack_require__(48), DEFAULT_CONTENT_TYPE = {
        ...
        var adapter, defaults = {
            adapter: ("undefined" != typeof XMLHttpRequest ? adapter = __webpack_require__(11) : void 0 !== process && (adapter = __webpack_require__(11)), 
            adapter),
    ...
    var _propTypes2 = _interopRequireDefault(__webpack_require__(2));
    ...
    __webpack_require__(39)(content, options);
    ...
    "use strict";
    var utils = __webpack_require__(0), settle = __webpack_require__(49), buildURL = __webpack_require__(51), parseHeaders = __webpack_require__(52), isURLSameOrigin = __webpack_require__(53), createError = __webpack_require__(12), btoa = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || __webpack_require__(54);
    module.exports = function(config) {
        return new Promise(function(resolve, reject) {
            ...
            request.timeout = config.timeout, request[loadEvent] = function() {
                ...
                var cookies = __webpack_require__(55), xsrfValue = (config.withCredentials || isURLSameOrigin(config.url)) && config.xsrfCookieName ? cookies.read(config.xsrfCookieName) : undefined;
            ...
            }), requestData === undefined && (requestData = null), request.send(requestData);
        });
    };
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    "use strict";
    var _react = _interopRequireDefault(__webpack_require__(1)), _reactDom = _interopRequireDefault(__webpack_require__(6)), _App = (_interopRequireDefault(__webpack_require__(21)), 
    _interopRequireDefault(__webpack_require__(42)));
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    }
    _reactDom["default"].render(_react["default"].createElement(_App["default"], null), document.getElementById("index"));
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    "use strict";
    var aa = __webpack_require__(1), n = __webpack_require__(5), r = __webpack_require__(18);
    function x(a) {
    ...
    var tf = {
        ...
        enqueueSetState: function(a, b, c) {
            ...
            e.payload = b, null != c && (e.callback = c), of(), pf(a, e), qf(a, d);
        },
        enqueueReplaceState: function(a, b, c) {
            a = a._reactInternalFiber;
            var d = lf(), e = nf(d = mf(d, a));
            e.tag = rf, e.payload = b, null != c && (e.callback = c), of(), pf(a, e), qf(a, d);
        },
    ...
    function vf(a, b, c) {
        ...
        f = (d = null != (d = b.contextTypes)) ? Je(a, e) : He), b = new b(c, f), a.memoizedState = null !== b.state && void 0 !== b.state ? b.state : null, 
        b.updater = tf, a.stateNode = b, b._reactInternalFiber = a, d && ((a = a.stateNode).__reactInternalMemoizedUnmaskedChildContext = e, 
    ...
    var kg = {
        ...
        useImperativeHandle: function(a, b, c) {
            return c = null != c ? c.concat([ a ]) : null, sg(4, Pf | Sf, ug.bind(null, b, a), c);
        },
        useLayoutEffect: function(a, b) {
        ...
        useImperativeHandle: function(a, b, c) {
            return c = null != c ? c.concat([ a ]) : null, tg(4, Pf | Sf, ug.bind(null, b, a), c);
        },
        useLayoutEffect: function(a, b) {
    ...
    function yh(a) {
        ...
        for (var e = a; ;) {
            ...
            null != (g = g._reactRootContainer) || null !== f.onclick || (f.onclick = te)) : b.appendChild(e.stateNode); else if (4 !== e.tag && null !== e.child) {
                ...
                for (var c = a; ;) {
                    if (5 === c.tag) {
                        ...
                        if (b) d.style.display = "none"; else {
                            ...
                            e = null != e && e.hasOwnProperty("display") ? e.display : null, d.style.display = ne("display", e);
                        }
    ...
    var _react = _interopRequireDefault(__webpack_require__(1)), _reactAddonsCssTransitionGroup = _interopRequireDefault(__webpack_require__(22)), _formInput = _interopRequireDefault(__webpack_require__(36)), _sheetButton = _interopRequireDefault(__webpack_require__(41));
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    }
    exports["default"] = class extends _react["default"].Component {
        constructor(props) {
        ...
        render() {
            ...
            return _react["default"].createElement("div", null, _react["default"].createElement(_formInput["default"], {
            ...
            }, names.length ? names.map(name => _react["default"].createElement(_sheetButton["default"], {
                name: name,
    ...
    var _extends = Object.assign || function(target) {
        ...
        return target;
    }, _react2 = _interopRequireDefault(__webpack_require__(1)), _propTypes2 = _interopRequireDefault(__webpack_require__(2)), _TransitionGroup2 = _interopRequireDefault(__webpack_require__(26)), _CSSTransitionGroupChild2 = _interopRequireDefault(__webpack_require__(30)), _PropTypes = __webpack_require__(8);
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    ...
    var _extends = Object.assign || function(target) {
        ...
        return target;
    }, _chainFunction2 = _interopRequireDefault(__webpack_require__(27)), _react2 = _interopRequireDefault(__webpack_require__(1)), _propTypes2 = _interopRequireDefault(__webpack_require__(2)), _ChildMapping = (_interopRequireDefault(__webpack_require__(28)), 
    ...
    var _extends = Object.assign || function(target) {
        ...
        return target;
    }, _addClass2 = _interopRequireDefault(__webpack_require__(31)), _removeClass2 = _interopRequireDefault(__webpack_require__(33)), _requestAnimationFrame2 = _interopRequireDefault(__webpack_require__(34)), _properties = __webpack_require__(35), _react2 = _interopRequireDefault(__webpack_require__(1)), _propTypes2 = _interopRequireDefault(__webpack_require__(2)), _reactDom = __webpack_require__(6), _PropTypes = __webpack_require__(8);
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    ...
    exports.__esModule = !0, exports["default"] = function(element, className) {
    ...
    var _hasClass = _interopRequireDefault(__webpack_require__(32));
    ...
    var _interopRequireDefault = __webpack_require__(3);
    exports.__esModule = !0, exports["default"] = void 0;
    var compatRaf, _inDOM = _interopRequireDefault(__webpack_require__(7)), cancel = "clearTimeout", raf = function(fn) {
    ...
    _inDOM["default"] && [ "", "webkit", "moz", "o", "ms" ].some(function(vendor) {
    ...
    "use strict";
    var _interopRequireDefault = __webpack_require__(3);
    exports.__esModule = !0, exports["default"] = exports.animationEnd = exports.animationDelay = exports.animationTiming = exports.animationDuration = exports.animationName = exports.transitionEnd = exports.transitionDuration = exports.transitionDelay = exports.transitionTiming = exports.transitionProperty = exports.transform = void 0;
    var prefix, transitionEnd, animationEnd, transitionProperty, transitionDuration, transitionTiming, transitionDelay, animationName, animationDuration, animationTiming, animationDelay, _inDOM = _interopRequireDefault(__webpack_require__(7)), transform = "transform";
    if (exports.transform = transform, exports.animationEnd = animationEnd, exports.transitionEnd = transitionEnd, 
    exports.transitionDelay = transitionDelay, exports.transitionTiming = transitionTiming, 
    exports.transitionDuration = transitionDuration, exports.transitionProperty = transitionProperty, 
    exports.animationDelay = animationDelay, exports.animationTiming = animationTiming, 
    exports.animationDuration = animationDuration, exports.animationName = animationName, 
    _inDOM["default"]) {
    ...
    var _react = _interopRequireDefault(__webpack_require__(1)), _propTypes = _interopRequireDefault(__webpack_require__(2));
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    ...
    class FormInput extends _react["default"].Component {
        ...
        render() {
            return _react["default"].createElement("div", {
                className: "formBlock"
            }, _react["default"].createElement("span", null, "Add a sheet: "), _react["default"].createElement("form", {
    ...
    exports["default"] = FormInput, FormInput.propTypes = {
        newSheetFormHandler: _propTypes["default"].func
    };
}, function(module, exports, __webpack_require__) {
    (exports = module.exports = __webpack_require__(38)(!1)).push([ module.i, "@import url(https://fonts.googleapis.com/css?family=Lora|Mukta);", "" ]), 
    ...
    }(), singleton = null, singletonCounter = 0, stylesInsertedAtTop = [], fixUrls = __webpack_require__(40);
    ...
    var _default = SheetButton;
    exports["default"] = _default, SheetButton.propTypes = {
        name: _propTypes["default"].object,
        deleteButtonHandler: _propTypes["default"].func,
        clickSheetNameHandler: _propTypes["default"].func
    };
}, function(module, exports, __webpack_require__) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
    ...
    }(__webpack_require__(1)), _axios = _interopRequireDefault(__webpack_require__(43)), _parse = _interopRequireDefault(__webpack_require__(63));
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    ...
    var _default = () => {
        const [header, setHeader] = (0, _react.useState)("Testing"), [users, setUsers] = (0, 
        _react.useState)([]), [endpoints, setEndpoints] = (0, _react.useState)([]);
        return (0, _react.useEffect)(() => {
            (async () => {
                const response = await _axios["default"].get("https://jsonplaceholder.typicode.com/users"), parsedResponse = (0, 
                _parse["default"])(response.data);
                setUsers(parsedResponse);
            })();
        }, []), (0, _react.useEffect)(() => {
            (async () => {
                const response = await _axios["default"].get("https://warm-peak-72707.herokuapp.com/api/endpoints");
                setEndpoints(response.data);
            })();
        }, []), (0, _react.useEffect)(() => {
            setHeader("Hi there");
        }, [ header ]), _react["default"].createElement("div", null, _react["default"].createElement("h1", null, header), _react["default"].createElement("ul", null, endpoints.map(endpoint => _react["default"].createElement("li", null, endpoint.name))), _react["default"].createElement("button", {
            onClick: e => (e => (e.preventDefault(), console.log("users are ", users), google.script.run.withSuccessHandler(data => console.log("success")).withFailureHandler(error => console.log(error.message)).setData(users)))(e)
        }, "Set values"));
    };
    exports["default"] = _default;
}, function(module, exports, __webpack_require__) {
    ...
    "use strict";
    var utils = __webpack_require__(0), bind = __webpack_require__(10), Axios = __webpack_require__(46), defaults = __webpack_require__(4);
    ...
    }, axios.Cancel = __webpack_require__(14), axios.CancelToken = __webpack_require__(61), 
    axios.isCancel = __webpack_require__(13), axios.all = function(promises) {
        return Promise.all(promises);
    }, axios.spread = __webpack_require__(62), module.exports = axios, module.exports["default"] = axios;
}, function(module, exports) {
    ...
    "use strict";
    var defaults = __webpack_require__(4), utils = __webpack_require__(0), InterceptorManager = __webpack_require__(56), dispatchRequest = __webpack_require__(57);
    ...
    "use strict";
    var utils = __webpack_require__(0), transformData = __webpack_require__(58), isCancel = __webpack_require__(13), defaults = __webpack_require__(4), isAbsoluteURL = __webpack_require__(59), combineURLs = __webpack_require__(60);
    ...
    var _papaparse = _interopRequireDefault(__webpack_require__(64)), _flatten = _interopRequireDefault(__webpack_require__(65));
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : {
            "default": obj
        };
    ...
    var _default = response => {
        const data = response, readyJson = (0, _flatten["default"])(data), unparse = _papaparse["default"].unparse(readyJson);
        return _papaparse["default"].parse(unparse).data;
    };
    exports["default"] = _default;
}, function(module, exports, __webpack_require__) {
    ...
    Array.isArray || (Array.isArray = function(e) {
    ...
    }), __WEBPACK_AMD_DEFINE_ARRAY__ = [], (__WEBPACK_AMD_DEFINE_RESULT__ = "function" == typeof (__WEBPACK_AMD_DEFINE_FACTORY__ = function() {
        "use strict";
                ...
                function e() {
                    if (0 !== h.length) {
                        ...
                        if (z(o.before)) {
                            ...
                            if ("object" == typeof s) {
                                if ("abort" === s.action) return t = n.file, r = n.inputElem, i = s.reason, void (z(o.error) && o.error({
                                    name: "AbortError"
                                }, t, r, i));
        ...
        function c(e) {
            ...
            (e = e || {}).chunkSize || (e.chunkSize = k.RemoteChunkSize), l.call(this, e), this._nextChunk = n ? function() {
                ...
                var t;
                4 === i.readyState && (i.status < 200 || 400 <= i.status ? this._chunkError() : (this._finished = !this._config.chunkSize || this._start > (null === (t = i.getResponseHeader("Content-Range")) ? -1 : parseInt(t.substr(t.lastIndexOf("/") + 1))), 
    ...
    const isObject = val => null !== val && (!Array.isArray(val) && ("function" == typeof val || "object" == typeof val)), isPrim = val => {
        const type = typeof val;
        return !("number" !== type && "string" !== type && "boolean" !== type && "null" != type);
    }, isArray = val => Array.isArray(val), parseObject = (obj, path) => {
        if (path == undefined && (path = ""), isObject(obj)) {
            const d = {};
            for (const i in obj) {
        ...
        if (isPrim(obj)) {
            const d = {};
            return d[path.substr(0, path.length - 1)] = obj, d;
        }
        return {};
    };
    var _default = json => {
        const inArray = (json => {
            ...
            let next = json;
            for (;next !== undefined; ) {
                if (isArray(next) && next.length > 0 && !isPrim(next[0])) return next;
                if (isObject(next)) for (const key in next) queue.push(next[key]);
                next = queue.shift();
            }
            return [ json ];
        })(json), outArray = [];
        for (const row in inArray) outArray[outArray.length] = parseObject(inArray[row]);
        return outArray;
    };
    exports["default"] = _default;
} ]);